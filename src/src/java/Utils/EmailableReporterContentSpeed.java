 ...
 */
public class EmailableReporterContentSpeed implements IReporter {

    private static final Logger LOG = Logger.getLogger(EmailableReporterContentSpeed.class);
    ...
    protected void writeScenarioDetails() {
        ...
        for (SuiteResult suiteResult : suiteResults) {
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                //context = suiteResult.getTestContext();
                ...
                //sessionId = UtilsSelenium.GetSessionBrowserStack(fisierConfigurari, browser, typeTest);
                System.out.println("SessionId: " + sessionId);
                writer.print("<h3>Session Id BrowserStack: ");
